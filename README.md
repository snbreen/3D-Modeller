...
Built an interactive 3D modelling application in Python featuring a scene graph,
procedural mesh generation, perspective projection, object transforms, scene
serialization, and Wavefront OBJ export.

## Stretch Ideas

- Add face/vertex selection and editing tools
- Add undo/redo with a command stack
- Add STL export
- Add material presets and basic lighting
- Replace the software renderer with PyOpenGL for real-time shaded rendering
